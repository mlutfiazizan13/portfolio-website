      ...
      <div className="container ontop">
          ...
          <div className="col-lg-7">
            <div className="caption">
              ...
              <h1 className="fw-700 mb-10">
                I&apos;m Muhamad <span className="main-color">Lutfi Azizan</span>
              </h1>
        ...
        <div className="info d-flex align-items-center justify-content-end mt-100">
          <div className="item">
            ...
            <span className="p-color">mlutfiazizan@gmail.com</span>
          </div>
          <div className="item">
            <h6 className="sub-title mb-10">Phone :</h6>
            <span className="p-color">+62 895-2924-8087</span>
          </div>
          <div className="item">
            <h6 className="sub-title mb-10">Address :</h6>
            <span className="p-color">Bogor, Indonesia</span>
          </div>
        </div>
      </div>
    </div>
